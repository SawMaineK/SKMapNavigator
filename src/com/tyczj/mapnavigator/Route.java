...
public class Route {
	...
	public String toString() {
		return "Route [path=" + path + ", legs=" + legs + ", totalDuration="
				+ totalDuration + ", totalDistance=" + totalDistance
				+ ", startLoc=" + startLoc + ", endLoc=" + endLoc + ", bounds="
				+ bounds + ", startAddress=" + startAddress + ", endAddress="
				+ endAddress + "]";
	}
